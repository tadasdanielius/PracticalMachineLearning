...
We can see clearly that model performs very well with accuracy `r cM$overall[1]*100`% ! Surely it is optimistic accuracy. The out of sample error is `r cM$overall[1]`. The out of sample error is calculated as `1 - accuracy` for predictions made against the cross-validation set. **which basically means that we have no out of sample errors !**.
